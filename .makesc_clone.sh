...
# optstring="a:b:c:C:d:e:g:k:l:p:r:s:S:t:T:h"
optstring="a:d:g:p:r:s:S:t:T:h"
while getopts "${optstring}" opt; do
    case "${opt}" in
        ...
        ;;
        #b)
        # create a jvm binary crate
        #    filename="${OPTARG}"

        #    mkdir -p out # make directory
        #    scalac -d out "${filename}"

         #   file="${filename%.*}"
         #   scala -cp "${file}".jar com.progscala3."${file,,}.${file}"
